...
function renderList(items) {
  ...
  for (const item of items) {
    ...
    plus.className = 'inline-flex h-8 w-8 items-center justify-center rounded-lg border border-slate-300 bg-white text-slate-700 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100';
    plus.type = 'button';
    plus.textContent = '+';
